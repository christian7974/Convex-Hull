...
void GUI_VISUALIZATION (std::vector<std::tuple<int, int, double>> plotted_points, std::stack<std::tuple<int, int, double>> graham_scan_stack)
{
	...
	int numPoints = plotted_points.size();
...
int main(int argc, char**argv) {
	...
	//push in the lowest pair to the vector or points so we can more easily display it

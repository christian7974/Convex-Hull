...
We used the programming language C++ in order to implement the algorithm. This repo also involves our project report as well as our presentations. We used a vector of 
